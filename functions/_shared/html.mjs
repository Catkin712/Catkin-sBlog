...
export function renderGuestbook(messages = []) {
    ...
    const body = `
        <section class="guestbook-page" aria-labelledby="guestbook-title">
            ...
            <div class="guestbook-sky" id="guestbook-sky" aria-live="polite" style="--cloud-count:${messages.length};">
                ${messages.length > 0
...
function renderGuestbookCloud(message, index, layout) {
...
function createGuestbookCloudLayouts(messages) {
    const placed = [];
...
function estimateGuestbookCloudBox(message, scale, skyHeight) {
...
function createGuestbookGridPosition(index, total, box) {
    const columns = 3;
