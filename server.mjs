...
const routes = [
    ...
    ["GET", /^\/admin\/albums\/?$/, "functions/admin/albums.js"],
    ...
    ["GET", /^\/api\/admin\/album-uploads$/, "functions/api/admin/album-uploads.js"],
    ["PATCH", /^\/api\/admin\/album-uploads\/([^/]+)$/, "functions/api/admin/album-uploads/[id].js", ["id"]],
    ["PATCH", /^\/api\/admin\/album-photos\/([^/]+)$/, "functions/api/admin/album-photos/[id].js", ["id"]],
    ["DELETE", /^\/api\/admin\/album-photos\/([^/]+)$/, "functions/api/admin/album-photos/[id].js", ["id"]],
    ...
    ["POST", /^\/api\/posts\/([^/]+)\/likes$/, "functions/api/posts/[slug]/likes.js", ["slug"]],
    ["POST", /^\/api\/posts\/([^/]+)\/comments$/, "functions/api/posts/[slug]/comments.js", ["slug"]],
